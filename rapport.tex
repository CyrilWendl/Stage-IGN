...
% TODO Notation
% TODO Explain better: Marge Bayes Pond / Marge Max / Marge Somme Pond / Moyenne  
% Bayes=Prod, Somme=Bayes Somme, CompromisWO=Walid Ouerghemmi
...
\begin{figure}[H]
    ...
    \label{fig:fusion\tile}
\end{figure}
The Min classifier produces patchy building contours, similar to the initial classifications on the  SPOT-6 and Sentinel-2 images. The SVM-t2 classifier manages to follow individual building contours more closely, however it loses some buildings in the northern part of the considered area.
...
\begin{itemize}
    \item Both classifiers have significant flaws : the SPOT-6 as well as the Sentinel-2 classifiers discover wrong buildings along roads in the North-Eastern part (fig. \ref{fig:cl_orig\tile}).
    The fusion
